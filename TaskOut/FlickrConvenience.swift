                        ...
                        if let photoCountInt = Int(photoCountString) {
                            if photoCountInt > 0 {
                                if let photosDictionary = photoDictionary[FlickrJSONResponseKeys.Photo] as? [[String:AnyObject]]{
                                    ...
                                    while (i < photosDictionary.count && i < 1) {
